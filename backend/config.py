...
# --------------------------------------------------------------------------- #
# LEGACY flat globals — Tasks 5–14 migrated most callers; survivors documented.
# --------------------------------------------------------------------------- #
...
# LAYER — still mutated by validation/harmfulness_pipeline.py and validation/csv_probe_sweep.py
# (EngineActivationProvider's layer-threading hack). WS1 will remove those scripts.
LAYER = int(os.getenv("LAYER", "17"))

# PHOENIX_ENDPOINT / EVAL_LLM_* — still read by coherence_eval._run() (WS1-deleted file).
